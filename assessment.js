...
var trueFaveNum = (faveNum === 22 ); //what is the point?
...
var responseCreator = function(param){
  if (param === "green") {colorResponse = "Green is okay"}
    ...
    return colorResponse; //no point of returing this as colorResponse is globally scoped
}
